...
namespace bmchain { namespace chain {
   ...
   using bmchain::protocol::weight_type;
...
FC_REFLECT_TYPENAME( bmchain::chain::shared_authority::account_authority_map)
FC_REFLECT( bmchain::chain::shared_authority, (weight_threshold)(account_auths)(key_auths) )
