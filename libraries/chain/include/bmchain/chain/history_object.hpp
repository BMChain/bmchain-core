...
FC_REFLECT( bmchain::chain::operation_object, (id)(trx_id)(block)(trx_in_block)(op_in_trx)(virtual_op)(timestamp)(serialized_op) )
CHAINBASE_SET_INDEX_TYPE( bmchain::chain::operation_object, bmchain::chain::operation_index )

FC_REFLECT( bmchain::chain::account_history_object, (id)(account)(sequence)(op) )
CHAINBASE_SET_INDEX_TYPE( bmchain::chain::account_history_object, bmchain::chain::account_history_index )
