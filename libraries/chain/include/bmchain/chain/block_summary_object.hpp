...
FC_REFLECT( bmchain::chain::block_summary_object, (id)(block_id) )
CHAINBASE_SET_INDEX_TYPE( bmchain::chain::block_summary_object, bmchain::chain::block_summary_index )
