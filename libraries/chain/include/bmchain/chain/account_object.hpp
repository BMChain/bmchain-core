...
FC_REFLECT( bmchain::chain::vesting_delegation_expiration_object,
            (id)(delegator)(vesting_shares)(expiration) )
CHAINBASE_SET_INDEX_TYPE( bmchain::chain::vesting_delegation_expiration_object, bmchain::chain::vesting_delegation_expiration_index )
