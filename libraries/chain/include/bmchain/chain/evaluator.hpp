...
template< typename OperationType=bmchain::protocol::operation >
class evaluator
{
   public:
...
template< typename EvaluatorType, typename OperationType=bmchain::protocol::operation >
...
class X ## _evaluator : public bmchain::chain::evaluator_impl< X ## _evaluator > \
{                                                                           \
   public:                                                                  \
      typedef X ## _operation operation_type;                               \
                                                                            \
      X ## _evaluator( database& db )                                       \
         : bmchain::chain::evaluator_impl< X ## _evaluator >( db )          \
      {}                                                                    \
                                                                            \
