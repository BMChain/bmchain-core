...
namespace detail
{
   ...
   {
      public:
         blockchain_statistics_api_impl( bmchain::app::application& app )
            :_app( app ) {}
...
blockchain_statistics_api::blockchain_statistics_api( const bmchain::app::api_context& ctx )
{
...
statistics& statistics::operator +=( const bucket_object& b )
{
   ...
   this->bmt_transferred                        += b.bmt_transferred;
   ...
   this->total_votes                            += b.new_root_votes + b.changed_root_votes + b.new_vestingly_votes + b.changed_reply_votes;
   this->new_votes                              += b.new_root_votes + b.new_vestingly_votes;
   ...
   this->total_vestingly_votes                      += b.new_vestingly_votes + b.changed_reply_votes;
   this->new_vestingly_votes                        += b.new_vestingly_votes;
   ...
   this->transfers_to_rep                   += b.transfers_to_rep;
   this->bmt_vested                             += b.bmt_vested;
   this->new_vesting_withdrawal_requests        += b.new_vesting_withdrawal_requests;
   this->savings_withdraw_rate_delta            += b.savings_withdraw_rate_delta;
   this->modified_rep_withdrawal_requests   += b.modified_rep_withdrawal_requests;
   this->rep_withdrawals_processed          += b.rep_withdrawals_processed;
   this->finished_rep_withdrawals           += b.finished_rep_withdrawals;
   this->vests_withdrawn                        += b.vests_withdrawn;
   this->vests_transferred                      += b.vests_transferred;
   this->bmt_converted                          += b.bmt_converted;
