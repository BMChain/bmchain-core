...
class blockchain_statistics_plugin : public bmchain::app::plugin
{
   public:
...
FC_REFLECT( bmchain::blockchain_statistics::bucket_object,
   (id)
   (open)
   (seconds)
   (blocks)
...
CHAINBASE_SET_INDEX_TYPE( bmchain::blockchain_statistics::bucket_object, bmchain::blockchain_statistics::bucket_index )
