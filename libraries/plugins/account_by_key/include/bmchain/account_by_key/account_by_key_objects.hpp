...
FC_REFLECT( bmchain::account_by_key::key_lookup_object, (id)(key)(account) )
CHAINBASE_SET_INDEX_TYPE( bmchain::account_by_key::key_lookup_object, bmchain::account_by_key::key_lookup_index )
