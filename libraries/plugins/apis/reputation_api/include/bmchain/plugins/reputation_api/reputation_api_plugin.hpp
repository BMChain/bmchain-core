#pragma once
#include <bmchain/plugins/reputation/reputation_plugin.hpp>
#include <bmchain/plugins/json_rpc/json_rpc_plugin.hpp>

#include <appbase/application.hpp>

#define BMCHAIN_REPUTATION_API_PLUGIN_NAME "reputation_api"
