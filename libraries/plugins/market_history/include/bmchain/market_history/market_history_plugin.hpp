...
class market_history_plugin : public bmchain::app::plugin
{
   public:
...
struct bucket_object : public object< bucket_object_type, bucket_object >
{
   ...
   price high()const { return asset( high_sbd, SBD_SYMBOL ) / asset( high_steem, BMT_SYMBOL ); }
   price low()const { return asset( low_sbd, SBD_SYMBOL ) / asset( low_steem, BMT_SYMBOL ); }
};
...
FC_REFLECT( bmchain::market_history::bucket_object,
                     (id)
                     (open)(seconds)
                     (high_steem)(high_sbd)
                     (low_steem)(low_sbd)
...
CHAINBASE_SET_INDEX_TYPE( bmchain::market_history::bucket_object, bmchain::market_history::bucket_index )

FC_REFLECT( bmchain::market_history::order_history_object,
                     (id)
                     (time)
                     (op) )
CHAINBASE_SET_INDEX_TYPE( bmchain::market_history::order_history_object, bmchain::market_history::order_history_index )
