...
class reserve_ratio_object : public object< reserve_ratio_object_type, reserve_ratio_object >
{
   public:
       ...
       *   reaches BMCHAIN_MAX_RESERVE_RATIO.  Any time average_block_size is greater than
       ...
       *
       *    max_bandwidth = maximum_block_size * BMCHAIN_BANDWIDTH_AVERAGE_WINDOW_SECONDS / BMCHAIN_BLOCK_INTERVAL
       *
...
FC_REFLECT_ENUM( bmchain::witness::bandwidth_type, (post)(forum)(market) )

FC_REFLECT( bmchain::witness::account_bandwidth_object,
            (id)(account)(type)(average_bandwidth)(lifetime_bandwidth)(last_bandwidth_update) )
CHAINBASE_SET_INDEX_TYPE( bmchain::witness::account_bandwidth_object, bmchain::witness::account_bandwidth_index )

FC_REFLECT( bmchain::witness::content_edit_lock_object,
            (id)(account)(lock_time) )
CHAINBASE_SET_INDEX_TYPE( bmchain::witness::content_edit_lock_object, bmchain::witness::content_edit_lock_index )

FC_REFLECT( bmchain::witness::reserve_ratio_object,
            (id)(average_block_size)(current_reserve_ratio)(max_virtual_bandwidth) )
CHAINBASE_SET_INDEX_TYPE( bmchain::witness::reserve_ratio_object, bmchain::witness::reserve_ratio_index )
