...
FC_REFLECT_ENUM( bmchain::follow::follow_type, (undefined)(blog)(ignore) )

FC_REFLECT( bmchain::follow::follow_object, (id)(follower)(following)(what) )
CHAINBASE_SET_INDEX_TYPE( bmchain::follow::follow_object, bmchain::follow::follow_index )

FC_REFLECT( bmchain::follow::feed_object, (id)(account)(first_reblogged_by)(first_reblogged_on)(reblogged_by)(comment)(reblogs)(account_feed_id) )
CHAINBASE_SET_INDEX_TYPE( bmchain::follow::feed_object, bmchain::follow::feed_index )

FC_REFLECT( bmchain::follow::blog_object, (id)(account)(comment)(reblogged_on)(blog_feed_id) )
CHAINBASE_SET_INDEX_TYPE( bmchain::follow::blog_object, bmchain::follow::blog_index )

FC_REFLECT( bmchain::follow::reputation_object, (id)(account)(reputation) )
CHAINBASE_SET_INDEX_TYPE( bmchain::follow::reputation_object, bmchain::follow::reputation_index )

FC_REFLECT( bmchain::follow::follow_count_object, (id)(account)(follower_count)(following_count) )
CHAINBASE_SET_INDEX_TYPE( bmchain::follow::follow_count_object, bmchain::follow::follow_count_index )

FC_REFLECT( bmchain::follow::blog_author_stats_object, (id)(blogger)(guest)(count) )
CHAINBASE_SET_INDEX_TYPE( bmchain::follow::blog_author_stats_object, bmchain::follow::blog_author_stats_index );
