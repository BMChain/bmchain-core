...
FC_REFLECT( bmchain::follow::follow_operation, (follower)(following)(what) )
FC_REFLECT( bmchain::follow::reblog_operation, (account)(author)(permlink) )

DECLARE_OPERATION_TYPE( bmchain::follow::follow_plugin_operation )

FC_REFLECT_TYPENAME( bmchain::follow::follow_plugin_operation )
