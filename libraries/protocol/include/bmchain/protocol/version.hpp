...
{
   class variant;
   void to_variant( const bmchain::protocol::version& v, variant& var );
   void from_variant( const variant& var, bmchain::protocol::version& v );

   void to_variant( const bmchain::protocol::hardfork_version& hv, variant& var );
   void from_variant( const variant& var, bmchain::protocol::hardfork_version& hv );
} // fc

#include <fc/reflect/reflect.hpp>
FC_REFLECT( bmchain::protocol::version, (v_num) )
FC_REFLECT_DERIVED( bmchain::protocol::hardfork_version, (bmchain::protocol::version), )

FC_REFLECT( bmchain::protocol::hardfork_version_vote, (hf_version)(hf_time) )
