 ...
 * - Length is between (inclusive) BMCHAIN_MIN_ACCOUNT_NAME_LENGTH and BMCHAIN_MAX_ACCOUNT_NAME_LENGTH
 */
bool is_valid_account_name( const string& name );

bool operator == ( const authority& a, const authority& b );

} } // namespace bmchain::protocol


FC_REFLECT_TYPENAME( bmchain::protocol::authority::account_authority_map)
FC_REFLECT_TYPENAME( bmchain::protocol::authority::key_authority_map)
FC_REFLECT( bmchain::protocol::authority, (weight_threshold)(account_auths)(key_auths) )
FC_REFLECT_ENUM( bmchain::protocol::authority::classification, (owner)(active)(key)(posting) )
