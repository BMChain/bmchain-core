...
FC_REFLECT( bmchain::protocol::escrow_transfer_operation, (from)(to)(sbd_amount)(steem_amount)(escrow_id)(agent)(fee)(json_meta)(ratification_deadline)(escrow_expiration) );
...
FC_REFLECT( bmchain::protocol::escrow_release_operation, (from)(to)(agent)(who)(receiver)(escrow_id)(sbd_amount)(steem_amount) );
...
FC_REFLECT( bmchain::protocol::claim_reward_balance_operation, (account)(reward_steem)(reward_sbd)(reward_vests) )
