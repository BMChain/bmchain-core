...
#define STEEMIT_INIT_PUBLIC_KEY_STR             "BMT76G5486bhLKXkXgN1nSkeDbpWEaiavF7i6tDULdpvyr69CLbHC"
...
#define STEEMIT_SYMBOL                          "BMT"
#define STEEMIT_ADDRESS_PREFIX                  "BMT"
...
#define STEEMIT_CASHOUT_WINDOW_SECONDS          (60*60*24)    /// 24 hours, bmchain /// (60*60*24*7)  /// 7 days
...
#define STEEMIT_UPVOTE_LOCKOUT_HF7              (fc::minutes(1))
#define STEEMIT_UPVOTE_LOCKOUT_HF17             (fc::hours(1)) /// bmchain /// (fc::hours(12))
...
#define STEEMIT_MIN_VOTE_INTERVAL_SEC           (0) /// bmchain stress-testing, было 3
#define STEEMIT_VOTE_DUST_THRESHOLD             (10000) /// bmchain stress-testing, было 50000000
