...
var data_message = operations.data_message;
var obj_message = operations.obj_message;
...
Auth.encryptText = function (private_key, public_key, message, nonce) {
  return aes.encrypt(private_key, public_key, message, nonce);
};

Auth.decryptText = function (private_key, public_key, nonce, message, checksum) {
  return aes.decrypt(private_key, public_key, nonce, message, checksum);
};

Auth.createDataMsg = function (from, to, sent_time, from_memo_key, to_memo_key, checksum, enc_message) {
  return data_message.toBuffer({
    from: from,
    to: to,
