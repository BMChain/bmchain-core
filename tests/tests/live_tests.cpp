...
BOOST_AUTO_TEST_CASE( vests_stock_split )
{
   try
   {
      ...
      auto old_rep_fund = db.get_dynamic_global_properties().total_vesting_fund_bmt;
      ...
      BOOST_REQUIRE( db.get_dynamic_global_properties().total_vesting_fund_bmt == old_rep_fund );
