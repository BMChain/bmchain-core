...
namespace bmchain { namespace example_plugin {

class hello_api_plugin : public bmchain::app::plugin
{
   public:
      /**
       ...
       */
      hello_api_plugin( bmchain::app::application* app );
...
{
   public:
      hello_api_api( const bmchain::app::api_context& ctx );
...
FC_API( bmchain::example_plugin::hello_api_api,
   (get_message)
   )

namespace bmchain { namespace example_plugin {

hello_api_plugin::hello_api_plugin( bmchain::app::application* app ) : bmchain::app::plugin(app) {}
...
hello_api_api::hello_api_api( const bmchain::app::api_context& ctx ) : _app(ctx.app) {}
...
/**
 * The BMCHAIN_DEFINE_PLUGIN() macro will define a bmchain::plugin::create_hello_api_plugin()
 * factory method which is expected by the manifest.
 */

BMCHAIN_DEFINE_PLUGIN( hello_api, bmchain::example_plugin::hello_api_plugin )
