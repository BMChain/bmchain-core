...
namespace steem {
   ...
   typedef static_variant< handshake_message, 
                      peer_message,
                      notice_message,
...
FC_REFLECT( steem::handshake_message, 
            (network_version)(chain_id)(node_id)
            (last_irreversible_block_num)(last_irreversible_block_num)
            (os)(agent) )

FC_REFLECT( steem::block_summary_message, (block)(trx_ids) )
FC_REFLECT( steem::notice_message, (known_trx)(known_blocks) )
FC_REFLECT( steem::sync_request_message, (start_block)(end_block) )
FC_REFLECT( steem::peer_message, (peers) )
